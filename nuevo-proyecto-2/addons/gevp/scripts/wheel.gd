...
var surface_type := ""
var tire_stiffnesses := { "Road" : 5.0, "Dirt" : 0.5, "Grass" : 0.5 , "remolques" : 0.0, "vehicles" : 0.0 }
var coefficient_of_friction := { "Road" : 2.0, "Dirt" : 1.4, "Grass" : 1.0 , "remolques" : 0.0, "vehicles" : 0.0 }
var rolling_resistance := { "Road" : 1.0, "Dirt" : 2.0, "Grass" : 4.0 , "remolques" : 0.0, "vehicles" : 0.0 }
var lateral_grip_assist := { "Road" : 0.05, "Dirt" : 0.0, "Grass" : 0.0, "remolques" : 0.0, "vehicles" : 0.0 }
var longitudinal_grip_ratio := { "Road" : 0.5, "Dirt": 0.5, "Grass" : 0.5, "remolques" : 0.0, "vehicles" : 0.0 }
